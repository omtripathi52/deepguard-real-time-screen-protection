            ...
            {industries.map(({ title, Icon, color, items }) => (
              <div key={title} style={{ background: "var(--bg)", border: "1px solid var(--ss-line)", borderRadius: 16, overflow: "hidden" }}>
                ...
                <div style={{ padding: "24px 22px 28px" }}>
                  <div style={{ width: 40, height: 40, background: `${color}18`, border: `1px solid ${color}28`, borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 14 }}>
