        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                By downloading, installing, or using ScreenSentinel, you agree to be bound by these Terms of Use. If you do not agree to these terms, do not use the software.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ScreenSentinel grants you a free, non-exclusive, non-transferable license to use the software for personal, non-commercial purposes. You may not modify, distribute, sell, or reverse engineer the software.
              </p>
            </section>
            ...
            <section className="glass-card rounded-2xl p-8 border-warning/20">
              ...
              <p className="text-foreground leading-relaxed">
                ScreenSentinel uses machine learning models to detect potential deepfakes. No detection system is perfect. ScreenSentinel provides confidence levels, not absolute determinations. You should not rely solely on ScreenSentinel for critical decisions. Always use your own judgment and seek additional verification when needed.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                In no event shall ScreenSentinel or its creators be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the software, including but not limited to damages from incorrect detection results.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                You agree not to use ScreenSentinel for any unlawful purpose or in any way that could damage, disable, or impair the software. ScreenSentinel is intended for personal use to help identify potentially manipulated media.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                We may update the software and these terms from time to time. Continued use of ScreenSentinel after changes constitutes acceptance of the updated terms.
              </p>
            </section>
